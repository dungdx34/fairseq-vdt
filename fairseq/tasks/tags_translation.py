...
def load_langpair_dataset(
    data_path, tags_data, split,
    src, src_dict, src_tags_dict,
    tgt, tgt_dict,
    ...
    assert len(src_datasets) == len(tgt_datasets) == len(src_tags_datasets) or len(tgt_datasets) == 0
...
class TranslationTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--tags-data', nargs='+' , help='paht(s) to tags data directorie(s)')
        # fmt: on
